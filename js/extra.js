...
/*
	...
	this.parse = function() {
		// this.base.rotation.z += VEIL.Params.orbitSpeed;
		...
		for(i=0; i<30; i++){
			tVector = this.rotateAroundAxis(this.rA.position, directionVector, VEIL.Params.osc*Math.PI);
		...
		for(i=0; i<this.totalRots; i++){
			...
			tVector = this.rotateAroundAxis(start.position, directionVector, VEIL.Params.osc*Math.PI);
			tVector.addSelf(this.pA.position);
		...
		vector = this.rotateAroundAxis(this.rA.position, directionVector, VEIL.Params.osc*Math.PI);
